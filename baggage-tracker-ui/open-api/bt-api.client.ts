...
export class BaggageTrackerClient {
     ...
     * @return Success
     */
    baggageQrCode(flightNumber: string | undefined): Observable<FileResponse> {
    ...
    protected processBaggageQrCode(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    baggageTracking(flightNumber: string): Observable<User[]> {
        let url_ = this.baseUrl + "/api/BaggageTracking/{flightNumber}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBaggageTracking(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBaggageTracking(response_ as any);
                } catch (e) {
    ...
    protected processBaggageTracking(response: HttpResponseBase): Observable<User[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    passengerAllowedStatuses(): Observable<PlainResponse> {
        let url_ = this.baseUrl + "/api/BaggageTracking/passenger-allowed-statuses";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPassengerAllowedStatuses(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPassengerAllowedStatuses(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PlainResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PlainResponse>;
        }));
    }

    protected processPassengerAllowedStatuses(response: HttpResponseBase): Observable<PlainResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    personnelAllowedStatuses(): Observable<PlainResponse> {
        let url_ = this.baseUrl + "/api/BaggageTracking/personnel-allowed-statuses";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPersonnelAllowedStatuses(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPersonnelAllowedStatuses(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PlainResponse>;
                }
            } else
    ...
    protected processPersonnelAllowedStatuses(response: HttpResponseBase): Observable<PlainResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    help(): Observable<PlainResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHelp(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PlainResponse>;
                }
            } else
    ...
    protected processHelp(response: HttpResponseBase): Observable<PlainResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PlainResponse implements IPlainResponse {
    ...
    constructor(data?: IPlainResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PlainResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PlainResponse();
        result.init(data);
        return result;
    }
...
export interface IPlainResponse {
    response?: any | undefined;
}
