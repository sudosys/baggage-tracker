...
export class AfterScanComponent implements OnInit {
  ...
  baggageBelongsToYou: string = "Looks like you retrieved your baggage!\nYou can mark it as 'I received my baggage' down below.";
  ...
  constructor(private dataService: InternalDataService, private router: Router, private baggageService: BaggageService) { }
